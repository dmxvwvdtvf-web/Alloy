...
class MetadataSet {
   public:
    ...
    virtual ErrorCode SaveMetadata(
        std::shared_ptr<Helper::DiskIO> p_metaOut,
        std::shared_ptr<Helper::DiskIO> p_metaIndexOut) = 0;
    ...
    virtual ErrorCode RefineMetadata(
        std::vector<SizeType>& indices,
        std::shared_ptr<MetadataSet>& p_newMetadata, std::uint64_t p_blockSize,
        std::uint64_t p_capacity, std::uint64_t p_metaSize) const;
    ...
    virtual ErrorCode RefineMetadata(std::vector<SizeType>& indices,
                                     const std::string& p_metaFile,
                                     const std::string& p_metaindexFile) const;

    static bool GetMetadataOffsets(const std::uint8_t* p_meta,
...
class FileMetadataSet : public MetadataSet {
   public:
    FileMetadataSet(const std::string& p_metaFile,
                    ...
                    std::uint64_t p_blockSize = 1024 * 1024,
                    std::uint64_t p_capacity = MaxSize,
    ...
    ErrorCode SaveMetadata(std::shared_ptr<Helper::DiskIO> p_metaOut,
...
class MemMetadataSet : public MetadataSet {
   public:
    MemMetadataSet(std::uint64_t p_blockSize, std::uint64_t p_capacity,
    ...
    MemMetadataSet(const std::string& p_metafile,
                   const std::string& p_metaindexfile,
                   std::uint64_t p_blockSize, std::uint64_t p_capacity,
                   std::uint64_t p_metaSize);

    MemMetadataSet(std::shared_ptr<Helper::DiskIO> p_metain,
   ...
   private:
    ErrorCode Init(std::shared_ptr<Helper::DiskIO> p_metain,
                   std::shared_ptr<Helper::DiskIO> p_metaindexin,
                   std::uint64_t p_blockSize, std::uint64_t p_capacity,
                   std::uint64_t p_metaSize);
