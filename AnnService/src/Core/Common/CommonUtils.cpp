...
template <typename T>
void Utils::BatchNormalize(T* data, SizeType row, DimensionType col, int base,
                           int threads) {
...
#define DefineVectorValueType(Name, Type)      \
    template void Utils::BatchNormalize<Type>( \
        Type * data, SizeType row, DimensionType col, int base, int threads);
#include "inc/Core/DefinitionList.h"
#undef DefineVectorValueType