...
DefineSSDParameter(m_enableDictTraining, bool, false, "EnableDictTraining")
...
DefineSSDParameter(m_searchPruning, bool, false, "SearchPruning")
DefineSSDParameter(m_monitorOutput, std::string, std::string(""), "MonitorOutput")
DefineSSDParameter(m_loopNum, int, 1, "LoopNum")
DefineSSDParameter(m_modelPath, std::string, std::string(""), "ModelPath")
DefineSSDParameter(m_errorMachineList, std::vector<int>, {}, "ErrorMachineIDs")
...
#ifdef DefineMergerParameter
DefineMergerParameter(m_enableMerger, bool, false, "isExecute")
DefineMergerParameter(m_loadMergerResult, bool, false, "LoadMergerResult")
DefineMergerParameter(m_numMachine, SPMerge::MachineID, 3, "NumMachine")
DefineMergerParameter(m_savePath, std::string, std::string("merger-result"), "SavePath")
DefineMergerParameter(m_recoveryPath, std::string, std::string("recovery"), "RecoveryPath")
DefineMergerParameter(m_indexFileFormat, std::string, std::string("machine_%u_index.bin"), "IndexFileNameFormat")
DefineMergerParameter(m_patchFileFormat, std::string, std::string("machine_%u_patch.bin"), "PatchFileNameFormat")
DefineMergerParameter(m_recoveryMethod, SPMerge::RecoveryMethod, SPMerge::RecoveryMethod::PureMemory, "RecoveryMethod")
DefineMergerParameter(m_recoveryNumThreads, int, 64, "RecoveryThreads")
DefineMergerParameter(m_numVecBuffers, size_t, 0, "NumVecBuffers")
DefineMergerParameter(m_curMid, SPMerge::MachineID, SPMerge::InvalidMID, "MachineID")
DefineMergerParameter(m_numLoadBuffers, int, 200, "NumLoadBuffers")
DefineMergerParameter(m_numReaderThreads, int, 10, "ReaderThreads")
DefineMergerParameter(m_numWriterThreads, int, 50, "WriterThreads")
DefineMergerParameter(m_nprobeRange, std::vector<int>, {}, "FeedModelNprobeRange")
DefineMergerParameter(m_numSplit, SPMerge::MachineID, 1, "NumSplit")
#endif

#ifdef DefineSeperatedIndexParameter
DefineSeperatedIndexParameter(m_rpcMethod, SSDServing::RPC_Method, SSDServing::RPC_Method::Callback, "RPCMethod")
DefineSeperatedIndexParameter(m_rpcWay, SSDServing::RPC_Way, SSDServing::RPC_Way::LoadBalance, "RPCWay")
DefineSeperatedIndexParameter(m_listeningPort, int, 50051, "port")
DefineSeperatedIndexParameter(m_serverAddrList, std::vector<std::string>, {}, "ServerAddrList")
#endif