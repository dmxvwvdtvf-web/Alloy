...
class AnnIndex {
   public:
    ...
    AnnIndex(const char* p_algoType, const char* p_valueType,
    ...
    bool BuildSPANNWithMetaData(ByteArray p_meta, SizeType p_num,
    ...
    std::shared_ptr<QueryResult> BatchSearch(ByteArray p_data, int p_vectorNum,
                                             int p_resultNum,
                                             bool p_withMetaData);
    ...
    static AnnIndex Merge(const char* p_indexFilePath1,
