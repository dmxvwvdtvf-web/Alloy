   ...
   protected:
       ...
       public:
        ...
        virtual void PrintDescription() {
            ...
            if (!m_representStringShort.empty()) {
                SPTAGLIB_LOG(Helper::LogLevel::LL_Empty, "%s",
                             m_representStringShort.c_str());
    ...
    void AddRequiredOption(DataType& p_target,
        ...
        m_arguments.emplace_back(
            std::shared_ptr<IArgument>(new ArgumentT<DataType>(
                p_target, p_representStringShort, p_representString,
                p_description, true, DataType(), true)));
    }
    ...
    void AddOptionalOption(DataType& p_target,
        ...
        m_arguments.emplace_back(
            std::shared_ptr<IArgument>(new ArgumentT<DataType>(
                p_target, p_representStringShort, p_representString,
                p_description, true, DataType(), false)));
    }
    ...
    void AddRequiredSwitch(DataType& p_target,
        ...
        m_arguments.emplace_back(
            std::shared_ptr<IArgument>(new ArgumentT<DataType>(
                p_target, p_representStringShort, p_representString,
                p_description, false, p_switchAsValue, true)));
    }
    ...
    void AddOptionalSwitch(DataType& p_target,
        ...
        m_arguments.emplace_back(
            std::shared_ptr<IArgument>(new ArgumentT<DataType>(
                p_target, p_representStringShort, p_representString,
                p_description, false, p_switchAsValue, false)));
    }
